...
exports.conexionAMongo = async (basedeDatos) => { // funcion asincronica que pasa como parametros basedeDatos
    try { // controla errores
        await mongoose.connect(`${URIMONGODB}/${basedeDatos}`) // espera y conecta mongoose a mongodb, pasas la uri y el argumento
